...
class CotacaoController:
    def __init__(self, parent_frame):
        # Inicializa o motor e a tela
        self.model = CotacaoModel()
        self.view = CotacaoView(parent_frame)

        # Conecta os botões da View às funções do Controller
    ...
    def carregar_arquivo(self):
        ...
        try:
            # Pede para o Model processar o arquivo
            itens, visao, qtd_cargas = self.model.processar_base_dados(caminho_entrada)
            
            # Pede para a View atualizar a interface
    ...
    def gerar_planilha(self):
        ...
        try:
            # Pega a ordem que o usuário deixou na tela
            ordem_desejada = self.view.obter_ordem_lista()
            
            # Pede para o Motor gerar o arquivo
